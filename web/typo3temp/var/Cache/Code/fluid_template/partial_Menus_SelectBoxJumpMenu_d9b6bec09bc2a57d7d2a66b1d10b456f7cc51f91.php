...
class partial_Menus_SelectBoxJumpMenu_d9b6bec09bc2a57d7d2a66b1d10b456f7cc51f91 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array11 = array();
$array12 = array (
);$array11['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('menuItem.active', $array12)]);
