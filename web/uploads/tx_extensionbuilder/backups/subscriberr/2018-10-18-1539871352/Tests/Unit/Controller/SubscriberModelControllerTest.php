<?php
namespace Test\Subscriberr\Tests\Unit\Controller;
...
{
    /**
     * @var \Test\Subscriberr\Controller\SubscriberModelController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Test\Subscriberr\Controller\SubscriberModelController::class)
    ...
    {
        $subscriberModel = new \Test\Subscriberr\Domain\Model\SubscriberModel();
