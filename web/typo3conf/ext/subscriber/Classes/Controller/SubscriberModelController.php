...
{
    /**
     * subscriberModelRepository
     *
     * @var \Test\Subscriber\Domain\Repository\SubscriberModelRepository
     * @inject
     */
    protected $subscriberModelRepository = null;
    ...
    {
        $this->addFlashMessage('You (' .$newSubscriberModel->getEmail() . ') subscribed for our updates', '', \TYPO3\CMS\Core\Messaging\AbstractMessage::WARNING);
